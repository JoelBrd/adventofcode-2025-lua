...
local function howManyRollsOfPaperCanBeAccessedByForkliftFour(grid)
	local total = 0
...
print(
	"Total Rolls of Paper that can be accessed by forklift:",
	howManyRollsOfPaperCanBeAccessedByForkliftFour(grid_rolls_of_paper)
)
